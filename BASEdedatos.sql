...
UNIQUE INDEX idx_materias_institucion_codigo_unique 
...
INSERT INTO instituciones (
  ...
  'IPR',
  '/assets/instituciones/paula-robles-logo.png',
...
INSERT INTO instituciones (
  ...
  'CUD',
  '/assets/instituciones/centro-universitario-logo.png',
...
-- ============================================
-- Este script incluye:
-- ✅ Todas las tablas principales del sistema académico
-- ✅ Tabla materias con campos profesor, curso y horario
-- ✅ Permite crear materias sin profesor (se asigna después)
-- ✅ Permite crear materias sin carrera_id (se asigna después)
-- ✅ Índices optimizados para búsquedas rápidas
-- ✅ Todas las foreign keys con validación
-- ✅ Triggers para actualizar timestamps
-- ✅ Row Level Security (RLS) habilitado
-- ✅ Datos iniciales: 2 instituciones y usuarios admin
-- ============================================
