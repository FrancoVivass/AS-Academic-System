-- ============================================
-- SCRIPTS SQL PARA AS-ACADEMIC-SYSTEM
...
-- Por ahora, permitir todo para desarrollo (ajustar en producción)
CREATE POLICY "Allow all for development" ON instituciones FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON usuarios FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON docentes FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON carreras FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON materias FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON aulas FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON cursos FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON alumnos FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON notas FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON asistencias FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON justificativos FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON eventos FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON mensajes FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON equivalencias FOR ALL USING (true);
CREATE POLICY "Allow all for development" ON auditoria FOR ALL USING (true);
